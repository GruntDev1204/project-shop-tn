...
Route::middleware(['api'])->group(function () {
    ...
    Route::group([
        ...
        Route::get('totp', [\App\Http\Controllers\AuthController::class, 'totpTest']);
        Route::post('totp', [\App\Http\Controllers\AuthController::class, 'verifiTOTP']);
    });
...
Route::get('/qr-code', function () {
    ...
    return \SimpleSoftwareIO\QrCode\Facades\QrCode::size(300)->generate($query);
});
